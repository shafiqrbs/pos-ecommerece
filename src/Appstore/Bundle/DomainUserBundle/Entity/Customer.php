...
class Customer
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Appstore\Bundle\DomainUserBundle\Entity\CustomerAddress", mappedBy="customer", cascade={"remove"})
     * @ORM\OrderBy({"id" = "DESC"})
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity="Appstore\Bundle\AccountingBundle\Entity\AccountSales", mappedBy="customer",cascade={"persist", "remove"})
     * @ORM\OrderBy({"id" = "DESC"})
     **/
    ...
    **/
     ...
     * @var string
     *
     * @ORM\Column(name="designationName", type="string",  nullable=true)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="employeeId", type="string",  nullable=true)
     */
    private $employeeId;
     ...
     * @var float
     *
     * @ORM\Column(name="availableCredit", type="float", nullable=true)
     */
