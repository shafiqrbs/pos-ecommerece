...
class Item
{
   ...
   /**
     ...
     * @var string
     *
     * @ORM\Column(name="categoryNameBn", type="string", length=255,nullable = true)
     */
    private $categoryNameBn;
     ...
     * @var string
     *
     * @ORM\Column(name="brandNameBn", type="string", length=255,nullable = true)
     */
    private $brandNameBn;
     ...
     * @var string
     *
     * @ORM\Column(name="sizeName", type="string", length=255,nullable = true)
     */
    private $sizeName;
     ...
     * @var string
     *
     * @ORM\Column(name="extraBn", type="string", length=255,nullable = true)
     */
    private $extraBn;
    ...
    /**
     * @return \Appstore\Bundle\EcommerceBundle\Entity\Item
     */
     ...
     * @return string
     */
    public function getCategoryNameBn()
    {
        return $this->categoryNameBn;
    }

    /**
     * @param string $categoryNameBn
     */
    public function setCategoryNameBn($categoryNameBn)
    {
     ...
     * @return string
     */
    public function getBrandNameBn()
    {
        return $this->brandNameBn;
    }

    /**
     * @param string $brandNameBn
     */
    public function setBrandNameBn($brandNameBn)
    {
     ...
     * @return string
     */
    public function getExtraBn()
    {
        return $this->extraBn;
    }

    /**
     * @param string $extraBn
     */
    public function setExtraBn($extraBn)
    {
        $this->extraBn = $extraBn;
    }
