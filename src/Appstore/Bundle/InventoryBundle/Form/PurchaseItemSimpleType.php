...
class PurchaseItemSimpleType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('salesPrice','text', array('attr'=>array('class'=>'itemInput m-wrap span4','placeholder'=>'MRP'),
                ))

            ->add('discountPrice','text', array('attr'=>array('class'=>'itemInput m-wrap span4','placeholder'=>'Sale price'),
                ))
