...
class AccountSalesController extends Controller
{
    ...
    */
    ...
    public function getCustomerSalesLedgerAction()
    {
        ...
        $currentCredit= ($customer->getCreditLimit() - $balance);
        $taka = number_format($currentCredit).' Taka';
        return new Response(json_encode(array('creditText' => $taka,'credit' => $currentCredit)));
