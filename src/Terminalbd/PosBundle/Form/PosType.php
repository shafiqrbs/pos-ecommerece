...
class PosType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('discountType','hidden', array('attr'=>array('value'=>'percent')))
            ->add('specialDiscount','text', array('attr'=>array('class'=>'tooltips span12 m-wrap input-number amount invoice-change','data-trigger' => 'hover','placeholder'=>'Discount','data-original-title'=>'Enter discount amount','autocomplete'=>'off')))
