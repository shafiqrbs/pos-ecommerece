 ...
 * ItemBrand
 *
 * @ORM\Table("product_item_brand")
 * @ORM\Entity(repositoryClass="Product\Bundle\ProductBundle\Entity\ItemBrandRepository")
 */
class ItemBrand
{
    /**
	...
	{
		return 'uploads/domain/'.$this->getGlobalOption()->getId().'/brand/';
	}
